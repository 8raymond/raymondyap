export const siteConfig = {
  ...
  projects: [
    {
      name: "Blue Origin Mk-II Lander Rotational Hand Controller Testbed<br/>Pending Blue Origin Export Approval",
      description:
    ...
    {
      name: "NASA CP-21 Rover Offloader: Lunar Lander Steward Platform<br/>Pending Blue Origin Export Approval",
      description:
