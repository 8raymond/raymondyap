export const siteConfig = {
  ...
  projects: [
    {
      name: "Blue Origin Mk-II Lander Rotational Hand Controller Testbed - <i>Pending Blue Origin Export Approval</i>",
      description:
    ...
    {
      name: "NASA CP-21 Rover Offloader: Lunar Lander Steward Platform - <i>Pending Blue Origin Export Approval</i>",
      description:
