export const siteConfig = {
  ...
  projects: [
    ...
    {
      name: "<span class='text-gray-400 italic'>Pending Blue Origin Export Approval</span><br/>NASA CP-21 Rover Offloader: Lunar Lander Steward Platform",
      description:
    ...
    },
    {
      ...
      link: "https://drive.google.com/drive/folders/1VMqEFfHcMA1pWUtIYVN5VuF1bzJTtQHz?usp=sharing",
