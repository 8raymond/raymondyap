export const siteConfig = {
  ...
  "I dedicate myself towards optimizing designs to their maximum efficiency in both functionality and/or cost, while utilizing CAD, analysis, and Engineering First Principles. I’ve previously worked 2 co-ops (6 mo. each), one at <strong>Blue Origin (Honeybee Robotics)</strong>, and the other at <strong>Instron</strong> <a href='https://www.instron.com' target='_blank' rel='noopener noreferrer' style='color: var(--accent-color); font-weight: bold; text-decoration: underline;'>(Co-op Portfolio)</a> under the automation team. Between NASA contracted lunar landers and 6-axis robotic arms, I’ve functioned as a mechanical engineer across a multitude of industries and design constraints.",
